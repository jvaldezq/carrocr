...
export const CarDialogDetailsSkeleton = () => {
    return <article
        className='text-tertiary grid grid-cols-1 gap-3 justify-center items-start animate-fade animate-once animate-duration-[600ms] animate-delay-0 animate-ease-linear'>
