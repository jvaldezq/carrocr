...
export const EconomyIcon = (props: HTMLAttributes<HTMLOrSVGElement>) => {
    return (<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 48 48" {...props}>
        <path fill="none" stroke="#F8F7FF" strokeLinecap="round" strokeLinejoin="round"
        ...
        <circle cx="24" cy="24" r="21.5" fill="none" stroke="#F8F7FF" strokeLinecap="round" strokeLinejoin="round"/>
        <path fill="none" stroke="#F8F7FF" strokeLinecap="round" strokeLinejoin="round"
